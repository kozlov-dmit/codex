...
public class CopyMigrationService implements MigrationService {
    private static final Logger log = LoggerFactory.getLogger(CopyMigrationService.class);
    ...
    public CopyMigrationService(Config config) {
        this.config = config;
    }
